...
OUTPUT_DIR = Path("/home/thermodynamics/document_translator_v14/test_output_database")
CHROMA_DIR = OUTPUT_DIR / "chromadb"

# ChromaDB collection settings
COLLECTION_NAME = "chapter_4_heat_transfer"
COLLECTION_DESCRIPTION = "Chapter 4 semantic chunks with citation enrichment"
